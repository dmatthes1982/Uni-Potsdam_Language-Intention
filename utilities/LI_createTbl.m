...
%   cfg.desFolder   = destination folder (default: '/data/tu_dmatthes_temp/LanguageIntention/eegData/EEG_LI_processedFT/00_settings/')
...
desFolder   = ft_getopt(cfg, 'desFolder', ...
          '/data/tu_dmatthes_temp/LanguageIntention/eegData/EEG_LI_processedFT/00_settings/');
